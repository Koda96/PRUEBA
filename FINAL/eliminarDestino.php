<!DOCTYPE html>
  <html>
    ...
    $query = "DELETE FROM `Destinos` WHERE `Destinos`.`Destinos_ID` = '$idDestino';";
          ...
          <div class="col s12 m6">
              <div class="card blue-grey darken-1 hoverable">
                <div class="card-content white-text">
                    ...
                    <p>Ha ocurrido un error al eliminar el destino de la agenda de contactos.</p>
                </div>
          ...
          <div class="col s12 m6">
              <div class="card blue-grey darken-1 hoverable">
                <div class="card-content white-text">
                    ...
                    <p>El destino se ha eliminado correctamente.</p>
                </div>
                <div class="card-action">
                    <a href="Destinos.php">Volver</a>
                </div>
